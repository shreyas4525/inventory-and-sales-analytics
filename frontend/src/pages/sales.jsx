...
const Sales = () => {
  ...
  const EmptyState = () => (
    <div className="empty_state">
      ...
      {isFiltered ? (
        <>
          <p style={{ color: "var(--text-secondary)", fontWeight: 500 }}>No sales found</p>
          <p style={{ marginTop: 4 }}>Try adjusting the date range.</p>
        </>
      ) : (
        <>
          <p style={{ color: "var(--text-secondary)", fontWeight: 500 }}>No sales yet</p>
          <p style={{ marginTop: 4 }}>Sales will appear here once you record them.</p>
        </>
      )}
    </div>
  );
